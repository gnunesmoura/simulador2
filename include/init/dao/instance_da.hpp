...
private:
    ...
    inline std::string loc_file() const { return "instancias/loc/" + m_instance_name + "_loc.txt"; }
    inline std::string rede_file() const { return "instancias/rede/" + m_instance_name + "_rede.txt"; }
    inline std::string result_file() const { return "instancias/result/" + m_instance_name + "_result.txt"; }
